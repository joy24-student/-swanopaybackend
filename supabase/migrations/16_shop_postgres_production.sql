...
CREATE TABLE IF NOT EXISTS "tbl_settings" (
  ...
  "smtp_from_name" VARCHAR(255) DEFAULT 'Your,
  ...
  "payment_methods" VARCHAR(255) NOT NULL DEFAULT 'PayPal,Bank,
  "review_feature_on_off" SMALLINT DEFAULT 1,
  "estimated_delivery_time_local" VARCHAR(255) DEFAULT '3-5,
  "estimated_delivery_time_international" VARCHAR(255) DEFAULT '10-20,

...
export const SUPABASE_URL = resolveSupabaseUrl((import.meta as any).env.VITE_SUPABASE_URL)
export const SUPABASE_ANON_KEY = resolveSupabaseKey((import.meta as any).env.VITE_SUPABASE_ANON_KEY)

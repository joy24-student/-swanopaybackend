...
$sslcz_mode = $settings_data['sslcz_mode'] ?? 0; // Corrected to sandbox_mode
...
if(isset($_POST['form_popup_settings'])) {
    $popup_on_off = $_POST['popup_on_off'];
    ...
    if ($valid == 1) {
        ...
        $statement->execute(array(
            ...
            $_POST['home_category_on_off'] ?? 1,
              $_POST['multi_vendor_on_off'],
        $_POST['coin_payment_on_off'],
        $_POST['desktop_advanced_layout_on_off'],
            // New Values
...
if(isset($_POST['form_payment_gateways'])) {
    $payment_methods_selected = isset($_POST['payment_methods']) ? implode(',', $_POST['payment_methods']) : '';
    ...
    $statement->execute(array(
        ...
        $_POST['sslcz_mode'] ?? 0, // Corrected to sandbox_mode
        $_POST['cod_enabled'] ?? 0,
...
$sslcz_store_id = $settings_data['sslcz_store_id'] ?? '';
$sslcz_store_pass = $settings_data['sslcz_store_pass'] ?? '';
$sslcz_mode = $settings_data['sslcz_mode'] ?? 0;
$cod_enabled = $settings_data['cod_enabled'] ?? 1;
$payment_methods = $settings_data['payment_methods'] ?? '';
$enabled_payment_methods_array = explode(',', $payment_methods);
...
$bg_color_featured_products = $settings_data['bg_color_featured_products'] ?? '#ffffff';
?>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="color" name="bg_color_featured_products" class="form-control" value="<?php echo $bg_color_featured_products; ?>">
    </div>
</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="sslcz_mode" id="sslcz_mode" class="form-control w-auto">
                                                <option value="1" <?php if($sslcz_mode == 1) {echo 'selected';} ?>>Sandbox</option>
                                                <option value="0" <?php if($sslcz_mode == 0) {echo 'selected';} ?>>Live</option>
                                            </select>
                                        </div>
                                    </div>
